		...
		<?php else : ?>
			...
			if ( current_user_can( 'edit_posts' ) ) :
				...
				<header class="entry-header">
					<h1 class="entry-title"><?php _e( 'No posts to display', 'carlaann' ); ?></h1>
				</header>
				...
				<div class="entry-content">
					...
					printf( __( 'Ready to publish your first post? <a href="%s">Get started here</a>.', 'carlaann' ), admin_url( 'post-new.php' ) );
					?>
					</p>
				</div><!-- .entry-content -->
