<?php
/**
 * Implement an optional custom function for Carla Analytics
 *
...
function load_css_files() {
	wp_deregister_style( 'carlaanalytics-style' ); 
    ...
    wp_register_style( 'carlaanalytics', get_stylesheet_uri(), array( 'normalize' ));
    wp_enqueue_style( 'carlaanalytics' );
	wp_enqueue_style( 'gfont-style','https://fonts.googleapis.com/css?family=Oswald:300,400,500,600,700|Roboto:100,300,400,500,700,900|Poppins:200,300,400,500,600,700,800,900|Bebas+Neue&display=swap', array(), '', false );
...
function footer_widgets_init() {
	register_sidebar( array(
		'name' => __( 'Footer Sidebar', 'carlaanalytics' ),
		'id' => 'sidebar-4',
		'description' => __( 'Appears on posts and pages footer', 'carlaanalytics' ),
...
function custom_post_css() {
   echo "<style type='text/css' media='screen'>
			...
			#adminmenu .menu-icon-carlaanalyticsevent div.wp-menu-image:before {
				font-family:  FontAwesome !important;
...
function carlaanalytics_rewrite_rules() {
    service_register();
    /*event_register();*/

    flush_rewrite_rules();
}
register_activation_hook( __FILE__, 'carlaanalytics_rewrite_rules' );
